...
-- Lesson Vocabulary Groups
DROP POLICY IF EXISTS "Users can view lesson vocabulary groups they own" ON lesson_vocabulary_groups;
DROP POLICY IF EXISTS "Users can manage lesson vocabulary groups they own" ON lesson_vocabulary_groups;

CREATE POLICY "Authenticated users have full access to lesson vocabulary groups" ON lesson_vocabulary_groups
    FOR ALL USING (is_authenticated());