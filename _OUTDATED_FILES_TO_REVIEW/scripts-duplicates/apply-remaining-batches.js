...
const MAIN_CATEGORIES = [
  ...
  { name: 'Writing Practice', id: 'b24667ac-c601-464f-8420-38156ec85a16', keywords: ['writing', 'effective writing', 'paragraph', 'essay writing', 'petrarca', 'charles dickens'] },
  { name: 'Reading & Writing', id: '3703f08f-5641-4778-9813-4a818bbfd859', keywords: ['reading & writing', 'reading and writing', 'integrated', 'boccaccio'] },
  { name: 'Vocabulary Enrichment', id: '41213d59-748a-4d0f-aa48-5e06f6d5abb9', keywords: ['vocabulary', 'words', 'word study'] },
  { name: 'Critical Analysis', id: 'ab452de7-4e54-4195-943d-f5c7f89429fa', keywords: ['critical', 'analysis', 'analytical', 'criticism', 'jane austen', 'oscar wilde'] },
  { name: 'Literature Analysis', id: 'c199ad8c-b875-4e33-9d3c-47fc82ae7a92', keywords: ['literature', 'literary', 'poetry', 'shakespeare', 'dante', 'canon', 'novel', 'goethe', 'lessing', 'schiller'] },
  { name: 'Essays', id: 'f15fcfcc-c3fd-46a6-8b24-1c4ee81d6008', keywords: ['essay', 'essays', 'academic writing', 'research', 'marlow'] }
];
...
// Skip header rows and get course data
const courseData = data.slice(2); // Skip first 2 rows (title and headers)

console.log(`Total courses in Excel: ${courseData.length}`);

// Skip the first 7 that were already imported in batch 1
const coursesToImport = courseData.slice(7);
