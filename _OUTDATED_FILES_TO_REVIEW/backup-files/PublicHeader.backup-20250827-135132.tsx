  ...
  const navigationItems: NavigationItem[] = [
    {
      ...
      dropdownContent: {
        column1: {
          title: 'Courses',
          items: [
            // Dynamic courses from database (up to 8)
            ...menuData.courses.slice(0, 8).map(course => ({
              name: course.title || '',
        ...
        {navigationItems.map((item) => (
          item.hasDropdown && activeDropdown === item.name && (
            <div 
              ...
              className="absolute top-full left-0 right-0 bg-white border-t border-gray-200/50"
              style={{
            ...
            >
              <div className={item.name === 'Store' ? "max-w-[1700px] mx-auto px-[22px] py-10" : "max-w-[980px] mx-auto px-[22px] py-10"}>
