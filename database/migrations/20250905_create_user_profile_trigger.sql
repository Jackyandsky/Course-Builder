-- Ensure user profiles table exists with proper structure
...
CREATE INDEX IF NOT EXISTS idx_user_profiles_needs_verification ON user_profiles(needs_verification);
...
DROP POLICY IF EXISTS "Parents can view children" ON user_profiles;
